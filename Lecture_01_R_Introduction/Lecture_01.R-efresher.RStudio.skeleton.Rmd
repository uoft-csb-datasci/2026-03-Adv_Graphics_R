...
::: {.alert .alert-block .alert-danger}
**Comprehension Question 3.2.9:** In the above example we used the **relocate()** function to move the "ReportingLaboratory" column to the start of our data frame. What other methods could we use to accomplish the same feat? Use the below code cell to help yourself out.
:::
